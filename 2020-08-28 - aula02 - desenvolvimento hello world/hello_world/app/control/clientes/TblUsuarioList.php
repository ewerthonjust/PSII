...
class TblUsuarioList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_TblUsuario';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de tbl usuarios");
        ...
        $row3 = $this->form->addFields([new TLabel("Sobrenome:", null, '14px', null, '100%'),$sobrenome]);
        $row3->layout = ['col-sm-12'];

        $row4 = $this->form->addFields([new TLabel("Empresa:", null, '14px', null, '100%'),$empresa]);
        $row4->layout = ['col-sm-12'];

        $row5 = $this->form->addFields([new TLabel("Tbl cidade id:", null, '14px', null, '100%'),$cidade]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['TblUsuarioForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_sobrenome = new TDataGridColumn('sobrenome', "Sobrenome", 'left');
        $column_empresa = new TDataGridColumn('empresa', "Empresa", 'left');
        $column_fk_cidade_nome = new TDataGridColumn('fk_cidade->nome', "Tbl cidade id", 'left');
        ...
        $this->datagrid->addColumn($column_sobrenome);
        ...
        $action_onEdit = new TDataGridAction(array('TblUsuarioForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('TblUsuarioList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Clientes","Tbl usuarios"]));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TblUsuario($key, FALSE); 
    ...
    public function onSearch()
    {
        ...
        if (isset($data->sobrenome) AND ( (is_scalar($data->sobrenome) AND $data->sobrenome !== '') OR (is_array($data->sobrenome) AND (!empty($data->sobrenome)) )) )
        {

            $filters[] = new TFilter('sobrenome', 'like', "%{$data->sobrenome}%");// create the filter 
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TblUsuario
