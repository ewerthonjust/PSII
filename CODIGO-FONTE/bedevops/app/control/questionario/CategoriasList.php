...
class CategoriasList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['CategoriasForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('CategoriasForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('CategoriasList', 'onDelete'));
    ...
    public function onSearch()
    {
        ...
        if (isset($data->categoria) AND ( (is_scalar($data->categoria) AND $data->categoria !== '') OR (is_array($data->categoria) AND (!empty($data->categoria)) )) )
        {
            ...
            $filters[] = new TFilter('categoria', 'like', "%{$data->categoria}%");// create the filter 
        }
