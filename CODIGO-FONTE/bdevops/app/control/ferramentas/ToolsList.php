...
class ToolsList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['ToolsForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('ToolsForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('ToolsList', 'onDelete'));
